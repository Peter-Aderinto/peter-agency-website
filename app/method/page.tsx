      ...
      <section className="inner-hero">
        <div className="container inner-hero-grid">
          <div className="reveal">
            ...
            <div className="method-hero-actions"><Link className="btn btn-accent btn-large" href="/free-audit#audit-request-form">Get a Free Store Audit<CtaArrow /></Link><Link className="btn btn-ghost btn-large" href="/portfolio">See Our Work<CtaArrow /></Link></div>
          </div>
