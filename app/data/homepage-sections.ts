export const homepagePortfolioItems = [
  ...
  {
    title: "Beauty and Fashion Website",
    tag: "ECOMMERCE WEBSITE",
    description: "Masterpiecefa is a Beauty and Fashion brand which sells female fashion products.",
    image: "/masterpiecefa.png",
    link: "https://masterpiecefa.com/",
  },
  {
    title: "Custom Pet Website",
    tag: "Ecommerce Website",
    description: "A friendly custom website for pet brands to showcase services, products, and care essentials.",
    image: "/pets.png",
