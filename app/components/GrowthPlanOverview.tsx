  ...
  return (
    <section className="section growth-included-section" id="growth-plan">
      <div className="container">
        ...
        <div className="growth-overview-actions reveal"><Link className="btn btn-accent btn-xl" href="/free-audit#audit-request-form">Get My Free Growth Plan</Link><Link className="text-link" href="/growth-plan">See How It Works ↗</Link></div>
      </div>
    </section>
  );
}
